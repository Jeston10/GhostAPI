...
const linkClass =
  "text-sm font-medium text-slate-400 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-sm";

function FooterHeading({ id, children }: { id: string; children: React.ReactNode }) {
  return (
    <p id={id} className="text-[11px] font-semibold uppercase tracking-[0.14em] text-slate-500">
      {children}
    </p>
  );
}
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 md:px-10 md:py-12 lg:px-12">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-x-10 lg:gap-y-0">
          <div className="flex flex-col items-center text-center sm:items-start sm:text-left lg:col-span-5">
            ...
            <p className="mt-4 max-w-md text-pretty text-sm leading-relaxed text-slate-400 lg:max-w-sm">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-7 lg:pl-4">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-3 border-t border-white/10 pt-8 text-xs text-slate-500">
